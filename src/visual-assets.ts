...
/** Each pose occupies an isolated 320px cell in the rebuilt production atlas. */
export const marianaRegions: readonly AnimationRegion[] = [
  marianaRegion("guard", "guard", 0, 0, 320, 320),
  marianaRegion("breathe", "breathe", 320, 0, 320, 320),
  marianaRegion("walk-a", "motion", 640, 0, 320, 320),
  marianaRegion("walk-b", "motion", 960, 0, 320, 320),
  marianaRegion("rise", "motion", 0, 320, 320, 320),
  marianaRegion("land", "motion", 320, 320, 320, 320),
  marianaRegion("crouch", "motion", 640, 320, 320, 320),
  marianaRegion("block", "motion", 960, 320, 320, 320),
  marianaRegion("hurt", "motion", 0, 640, 320, 320),
  marianaRegion("fall", "motion", 320, 640, 320, 320),
  marianaRegion("punch-wind", "motion", 640, 640, 320, 320),
  marianaRegion("punch-hit", "motion", 960, 640, 320, 320),
  marianaRegion("kick-wind", "motion", 0, 960, 320, 320),
  marianaRegion("kick-hit", "motion", 320, 960, 320, 320),
  marianaRegion("low-punch", "motion", 640, 960, 320, 320),
  marianaRegion("low-kick", "motion", 960, 960, 320, 320),
  marianaRegion("special-wind", "motion", 0, 1280, 320, 320),
  marianaRegion("special-hit", "motion", 320, 1280, 320, 320),
  marianaRegion("air-punch", "air", 640, 1280, 320, 320),
  marianaRegion("air-kick", "air", 960, 1280, 320, 320),
  marianaRegion("low-special", "air", 0, 1600, 320, 320),
];
