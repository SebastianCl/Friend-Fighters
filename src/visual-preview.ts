  ...
  <div class="viewport">
    <section class="arena" aria-label="Dos vistas de la misma luchadora en Distrito Neón">
      ...
      <header class="arena-header">
        <a class="arcade-brand" href="/" aria-label="Volver al juego"><span class="brand-icon">FF</span>FIGHTER <b>FRIENDS</b></a>
